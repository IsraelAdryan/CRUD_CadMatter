...
/**
 * Essa classe está responsável por indicar a URL inicial do site, bem como a
 * URL de login e possivel erro de login, informando uma mensagem de erro.
 */
...
public class inicioController {
	...
	/**
	 * Especifica a URL que será carregada caso o login não seja efetuado com
	 * sucesso.
	 * 
